...
@injectable()
export class EnterPreviewStateListener implements AppMessageListener<ManuallyBlockingAdsEnterPreviewMessage> {
  constructor (
    @inject(ContentManuallyBlockingAdsIdentifiers.service)
    private readonly selector: SelectorService
  ) {}

  on (): ManuallyBlockingAdsMessages.enterPreview {
    return ManuallyBlockingAdsMessages.enterPreview
  }

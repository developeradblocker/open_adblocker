...
import { RateUsCloseNotificationMessage, RateUsMessages, RateUsRatedMessage } from '../../common/rate-us.messages'
...
export class RateUsService {
  ...
  rate (): void {
    const message: RateUsRatedMessage = {
  ...
  closeNotification (): void {
    const message: RateUsCloseNotificationMessage = {

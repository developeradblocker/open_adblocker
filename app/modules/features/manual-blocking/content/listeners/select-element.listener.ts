...
@injectable()
export class SelectElementListener implements AppMessageListener<ManualBlockingSelectElementMessage> {
  constructor (
  ...
  on (): ManualBlockingMessages.selectElement {
    return ManualBlockingMessages.selectElement
  }

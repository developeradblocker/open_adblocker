...
@injectable()
export class StartManualAdBlockingListener implements AppMessageListener<ManualBlockingStartMessage> {
  constructor (
  ...
  on (): ManualBlockingMessages.start {
    return ManualBlockingMessages.start
  }

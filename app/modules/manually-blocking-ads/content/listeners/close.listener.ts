...
@injectable()
export class CloseManualAdBlockingListener implements AppMessageListener<ManuallyBlockingAdsCloseMessage> {
  constructor (
  ...
  on (): ManuallyBlockingAdsMessages.close {
    return ManuallyBlockingAdsMessages.close
  }

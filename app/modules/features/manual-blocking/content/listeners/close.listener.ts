...
@injectable()
export class CloseManualAdBlockingListener implements AppMessageListener<ManualBlockingCloseMessage> {
  constructor (
  ...
  on (): ManualBlockingMessages.close {
    return ManualBlockingMessages.close
  }

...
@injectable()
export class StopManualAdBlockingListener implements AppMessageListener<ManuallyBlockingAdsStopMessage> {
  constructor (
  ...
  on (): ManuallyBlockingAdsMessages.stop {
    return ManuallyBlockingAdsMessages.stop
  }

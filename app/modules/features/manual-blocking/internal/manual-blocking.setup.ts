...
} from '@/modules/features/manual-blocking/internal/services/manual-blocking.service'
import {
  InternalManualBlockingIdentifiers, InternalManualBlockingServiceInterface
...
export const setupInternalManualBlocking = (): void => {
  ...
  dispatcher().onWithClass(SaveListener)
}

...
describe('makeOnAfterListener', () => {
  it('should register the listener using dispatcher onAfter', () => {
    ...
    const registerListener = makeOnAfterListener(messageType)
    registerListener(listener)

    expect(onAfterMock).toHaveBeenCalledWith(messageType, listener)
  })
})
